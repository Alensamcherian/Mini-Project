...
Button(a,text="QUIT",height=2,font="Bahnschrift 14 bold",command=quit,width=10,border=0,background="#c12b2b",activebackground="black", activeforeground="white",highlightcolor="black").place(x=225,y=400)
Label(a,text="\nDEVELOPED BY",font="Tw-Cen-MT-Condensed-Extra-Bold 13 bold",bg="#f4ab79").place(x=215,y=500)
Label(a,text="ALEN ",font="Tw-Cen-MT-Condensed-Extra-Bold 11 bold",bg="#f4ab79").place(x=250,y=560)
a.mainloop()
